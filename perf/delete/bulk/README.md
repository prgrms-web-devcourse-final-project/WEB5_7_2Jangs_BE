...
- `perf/delete/bulk/delete_only_benchmark.js`
  - 생성된 문서를 찾아 삭제만 수행
- `perf/delete/bulk/compare_delete_summary.mjs`
  - 두 브랜치 결과 비교 표 출력
...
USER_COUNT=100 DOCS_PER_USER=3 \
DELETE_VUS=30 \
k6 run perf/delete/bulk/delete_only_benchmark.js \
  --summary-export perf/delete/bulk/results/delete/delete_only_summary.json
```
...
- `perf/delete/bulk/results/delete/dev_delete_summary.json`
- `perf/delete/bulk/results/delete/refactor_delete_summary.json`

비교:

```bash
node perf/delete/bulk/compare_delete_summary.mjs \
  perf/delete/bulk/results/delete/dev_delete_summary.json \
  perf/delete/bulk/results/delete/refactor_delete_summary.json
```
