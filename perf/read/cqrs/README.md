...
- `perf/read/cqrs/doc_list_benchmark.js`
  - `sidebar`, `full list`, `search` 읽기 성능 측정
- `perf/read/graph/doc_graph_benchmark.js`
...
k6 run perf/read/cqrs/doc_list_benchmark.js
```
...
- `perf/read/cqrs/results/<test-name>/.../*.json`
...
k6 run perf/read/graph/doc_graph_benchmark.js
```
...
```text
perf/read/commit-cache/results/<provider>/blocks-<count>/<pattern>/<load-profile>/run-<1|2|3>/
```
