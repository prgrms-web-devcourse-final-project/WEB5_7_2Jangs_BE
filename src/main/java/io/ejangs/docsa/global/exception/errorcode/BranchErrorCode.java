...
public enum BranchErrorCode implements ErrorCode {
    ...
    MAIN_BRANCH_DELETE_UNAVAILABLE(HttpStatus.BAD_REQUEST, "메인 브랜치는 삭제할 수 없습니다", "MAIN_BRANCH_DELETE_UNAVAILABLE"),
    SUB_BRANCH_DELETE_UNAVAILABLE(HttpStatus.BAD_REQUEST, "서브브랜치가 있어 해당 브랜치를 삭제할 수 없습니다", "SUB_BRANCH_DELETE_UNAVAILABLE"),
