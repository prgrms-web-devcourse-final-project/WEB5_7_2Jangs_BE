...
public enum SaveErrorCode implements ErrorCode {
    ...
    FAIL_TO_SAVE_IN_MYSQL(HttpStatus.INTERNAL_SERVER_ERROR, "저장에 실패했습니다.", "SAVE_CREATE_MYSQL_FAIL"),
    FAILED_TO_SAVE_IN_MONGO(HttpStatus.INTERNAL_SERVER_ERROR, "저장을 실패했습니다.", "SAVE_CREATE_MONGO_FAIL");
